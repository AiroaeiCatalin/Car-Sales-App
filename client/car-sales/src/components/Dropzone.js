...
const Dropzone = ({adResponse}) => {
    //Aici cred ca pot sa bag si pe rand tot cate o poza, doar ca trb din acceptedFiles sa le bag intr un alt state si tot adaug la stateu ala cand dau drag and drop, pana cand dau ok si atunci imi face post si ma duce back p homepage
